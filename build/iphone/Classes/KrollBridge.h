...
@interface TranslatorObject : KrollCoverageObject {
#else
@interface TranslatorObject : KrollObject {
#endif
@private
...
extern NSString * Translator$ModuleRequireFormat;

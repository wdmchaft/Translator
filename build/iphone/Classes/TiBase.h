...
// in simulator we redefine to format for Translator Developer console
...
{\
	NSString * exceptionName = [@"org.translator." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.translator";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITranslatorNativeItemNone = -1, 
	UITranslatorNativeItemSpinner = -2,
	UITranslatorNativeItemProgressBar = -3,
	
	UITranslatorNativeItemSlider = -4,
	UITranslatorNativeItemSwitch = -5,
	UITranslatorNativeItemMultiButton = -6,
	UITranslatorNativeItemSegmented = -7,
	
	UITranslatorNativeItemTextView = -8,
	UITranslatorNativeItemTextField = -9,
	UITranslatorNativeItemSearchBar = -10,
	
	UITranslatorNativeItemPicker = -11,
	UITranslatorNativeItemDatePicker = -12,
	
	UITranslatorNativeItemInfoLight = -13,
	UITranslatorNativeItemInfoDark = -14,
	
	UITranslatorNativeItemDisclosure = -15,
	
	UITranslatorNativeItemContactAdd = -16
};

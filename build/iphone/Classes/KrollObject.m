 ...
 * Copyright (c) 2009-2011 by Translator, Inc. All Rights Reserved.
...
//@interface TranslatorObject : NSObject
//@end

@interface TranslatorObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TranslatorObject class]])
		{
			for (NSString *key in [[(TranslatorObject*)o modules] allKeys])
			{
